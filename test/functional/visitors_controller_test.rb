...
class VisitorsControllerTest < ActionController::TestCase
  ...
  test "should create visitor" do
    assert_difference('Visitor.count') do
      post :create, visitor: { address: @visitor.address, age: @visitor.age, name: @visitor.name, sex: @visitor.sex }
    end
  ...
  test "should update visitor" do
    put :update, id: @visitor, visitor: { address: @visitor.address, age: @visitor.age, name: @visitor.name, sex: @visitor.sex }
    assert_redirected_to visitor_path(assigns(:visitor))
  end
